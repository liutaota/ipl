...
public interface PubMonthlySalesMapper extends BaseMapper<PubMonthlySales> {
    ...
    IPage<PubMonthlySales> selectPageList(Page page, @Param("salesIdList") List<Long> salesIdList, @Param("customids") String customids, @Param("tomonthss") String tomonthss, @Param("startTime") String startTime, @Param("endTime") String endTime);
